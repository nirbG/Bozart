    ...
    <body>		
		...
		<div id="wrapper" class="container">
				...
				<div class="flexslider">
					<ul class="slides">
						<li>
							...
							<div class="intro">
								<h1>Bienvenu chez Bozart</h1>
								<p><span>Le prix du gros au détail.</span></p>
								<p><span>C'est le choix de la qualité parmi un large éventail de produits concernant la peinture.</span></p>
							</div>
						</li>
						<li>
							...
							<div class="intro">
								...
								<p><span>nous vous proposon un large choix de marque</span></p>
						...
						<li>
							...
							<div class="intro">
								...
								<p><span>nous vous offrons de quoi imortaliser vos oeuvre</span></p>
			...
			<section class="header_text">
				Bienvenu sur notre site, nous vous proposons un large choix de produit d'art.  
                ...
                $cont = $cont . <<<END
							<li class="spaan3carousel $bye">
								<div class="product-box">
									...
									<p><a href="$urldetail"><img src="themes/images/Products/$sl->nom/$item->img" alt="" /></a></p>
									<div class="nom">
							...
							<div class="span4">
								<div class="service">
									<div class="responsive">	
										...
										<h4>vendeur de materiel<strong> D'art</strong></h4>
							...
							<div class="span4">	
								<div class="service">
									<div class="customize">			
										...
										<p>vous pouvez retrouver votre commande dans notre magasin ou on vous l'envoie.</p>
									</div>
								</div>
							</div>
							<div class="span4">
